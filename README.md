...
## 8) Готовая «одна папка версии»
Чтобы было максимально просто, добавлена заготовка:
- `client-mod/1.21.1-client-mod/`

Туда нужно положить собранный jar и назвать его `1.21.1-client-mod.jar`, после чего
просто скопировать эту одну папку в `.minecraft/versions/`.

Подробно: `client-mod/INSTALL.md`.
